...
//        this.profesorDAO = new ProfesorDAOImpl(setDB, Curso.class);
//    }
//
//    @Test
...
//        var curso = this.profesorDAO.findById(1);
...
//        this.profesorDAO.save(new Curso(4, "Musica", "RockStar", 4));
//        var curso = this.profesorDAO.findById(4);
